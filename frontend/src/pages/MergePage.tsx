...
/** Map a raw KiCad item type to its category. Lived in diff-grouping.ts until that
 * dropped it as unused; this page is its only caller. */
function categoryFor(type: string | undefined): Category {
