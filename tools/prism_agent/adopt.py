...
# Matches the server's git_host_service.default_gitignore. Duplicated rather than
# fetched: this has to work before the project exists, and a .gitignore is not worth a
# round trip.
GITIGNORE = """# KiCad backups and autosaves
*-backups/
*.kicad_prl
*.kicad_pcb-bak
*.kicad_sch-bak
